...
if(isset($_POST['search']))
{
  ...
  $endprice= $_POST['End-Price'];
  $_SESSION['product']=$product;
  $_SESSION['startprice']=$startprice;
  $_SESSION['endprice']=$endprice;
}
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://price-api.datayuge.com/api/v1/compare/search?api_key=suwVAxHngQ7O3a3TorWBKqSgFqNXlQqB27V&product=".$_SESSION['product']."&price_start=".$_SESSION['startprice']."&price_end=".$_SESSION['endprice']."&page=1",
...
if ($err) {
  ...
  $url = 'https://price-api.datayuge.com/api/v1/compare/search?api_key=suwVAxHngQ7O3a3TorWBKqSgFqNXlQqB27V&product='.$_SESSION['product'].'&price_start='.$_SESSION['startprice'].'&price_end='.$_SESSION['endprice'].'&page=1';
...
<div class="main_s">
    ...
    <?php for($k=0 ; $k< count($i['data']) ;$k++)
      ...
      <div class="row">
        ...
        <div class="col-sm-3 col-md-3 bg-sucess">
        <!-- card -->
        ...
        <div class="col-sm-5 col-md-5 bg-sucess">
